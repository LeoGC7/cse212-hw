...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: It was not handling correctly the numbers of turns for each person, and people with 0 turns were not being properly re-enqueued
    ...
    // Defect(s) Found: It was not working when we added a new person in the middle of the cicle, and not maitaining the order
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: It was not handling correctly Tim's turns, which are 0
    ...
    // Defect(s) Found: It was not correctly hanlding negative turns
